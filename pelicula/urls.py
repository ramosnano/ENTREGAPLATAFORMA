...
from pelicula.views import List_movie, Create_movie_view, search_movie_view, Update_movie, Detail_movie, Delete_movie

urlpatterns =[
    path('', List_movie.as_view(), name = 'list-peliculas'),
    path('crear-peliculas/', Create_movie_view.as_view(), name = 'create-peliculas'),
